...
import tetraDMO_Decoder_epy_block_0_1 as epy_block_0_1  # embedded python block
...
class tetraDMO_Decoder(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.view_step = view_step = 520*8
        ...
        self.epy_block_0_1 = epy_block_0_1.blk(step=view_step, change=next_view)
        self.epy_block_0 = epy_block_0.dmoBurstSync(dmoMode=True)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_char*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/ctn008/tetraDMO-Receiver/RxDMO_pluto_s36kBit.uint8', False, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_char_to_float_0_0, 0), (self.epy_block_0_1, 0))
    ...
    def set_view_step(self, view_step):
        ...
        self.epy_block_0_1.step = self.view_step
    ...
    def set_next_view(self, next_view):
        ...
        self.epy_block_0_1.change = self.next_view
